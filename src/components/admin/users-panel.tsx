...
import { PERMISSION_GROUPS, ROLE_PRESETS, ALL_PERMISSION_IDS } from '@/lib/permissions'
                  ...
                  <div className="flex min-w-0 flex-1 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="truncate text-[11px] text-foreground-500/70">
                        Kayıt: {u.createdAt ? new Date(u.createdAt).toLocaleString('tr-TR') : '—'}
                        {u.lastSignIn
                        ...
                        <div className="max-h-[60vh] w-80 overflow-y-auto px-1 py-2">
                          <div className="mb-2 flex items-center justify-between gap-2">
                            <p className="text-xs font-semibold text-foreground-500">
                              Özel Yetkiler ({draftPerms.length}/{ALL_PERMISSION_IDS.length})
                            </p>
